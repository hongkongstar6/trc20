...
5. `withdraw_record`：`id, order_no(唯一), uid, coin_id, to_address, amount, txid, signed_raw, expire_at, status(created/signed/broadcast/confirmed/failed/expired), retry_count, fail_reason`
